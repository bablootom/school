...
<a href="javascript:;" onclick="showAjaxModal('<?php echo site_url('modal/popup/student_add/');?>');" 
            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        ...
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo site_url('teacher/student/'.$class_id.'/delete/'.$row['student_id']);?>');">
