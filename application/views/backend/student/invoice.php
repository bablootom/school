                ...
                <table  class="table table-bordered datatable" id="table_export">
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <?php echo form_open(site_url('student/paypal_checkout/'.. $row['student_id']));?>
                    	<input type="hidden" name="invoice_id" value="<?php echo $row['invoice_id'];?>" />
                    		<button type="submit" class="btn btn-info" <?php if($row['due'] == 0):?> disabled="disabled"<?php endif;?>>
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <?php echo form_open(site_url('student/stripe_checkout/'.$row['student_id']));?>
                    	<input type="hidden" name="invoice_id" value="<?php echo $row['invoice_id'];?>" />
                    		<button type="submit" class="btn btn-default" <?php if($row['due'] == 0):?> disabled="disabled"<?php endif;?>>
