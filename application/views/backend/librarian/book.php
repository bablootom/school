                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo site_url('modal/popup/book_edit/'.$row['book_id']);?>');">
                                    ...
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo site_url('librarian/book/delete/'.$row['book_id']);?>');">
