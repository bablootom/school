...
<html class="no-js" lang="">
    <head>
      ...
      <link rel="stylesheet" href="<?php echo base_url('assets/login_page/css/style1.css');?>">
		...
		<div class="main-content-wrapper">
			<div class="login-area">
				<div class="login-header">
					<a href="<?php echo site_url('login');?>" class="logo">
						<img src="<?php echo base_url('assets/login_page/img/logo.png');?>" height="110" alt="">
					</a>
            ...
            action="<?php echo site_url('login/validate_login');?>">
						<div class="form-group">
							<input type="البريد الإلكتروني" class="input-field" name="email" placeholder="<?php echo get_phrase('email');?>"
                required autocomplete="off">
						</div>
						<div class="form-group">
							<input type="كلمه السر" class="input-field" name="password" placeholder="<?php echo get_phrase('password');?>"
                required>
						</div>
						<button type="خضع" class="btn btn-primary"><?php echo get_phrase('login'); ?><i class="fa fa-lock"></i></button>
					</form>
