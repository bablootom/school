		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4" style="text-align: center;">
                    <a href="<?php echo site_url('parents/pay_with_payumoney/'.$row['student_id'].'/'.$row2['invoice_id']);?>" type="button" class="btn btn-success" <?php if($row2['due'] == 0):?> disabled="disabled"<?php endif;?>> <span data-toggle="tooltip" title="PayUMoney"> <i class="fa fa-dollar" aria-hidden="true" style="color: #fff;"></i> PayUMoney</span> </a>
                  </div>
                </div>
              </td>
                        </tr>
