                ...
                <table class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                    		...
                    		<th><div><?php echo get_phrase('class_capacity');?></div></th>-->
                ...
                <div class="box-content">
                	<?php echo form_open(site_url('admin/classes/create') , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php //echo get_phrase('class_capacity');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="class_capacity"/>
                                </div>
                            </div> -->
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="teacher_id" class="form-control" style="width:100%;">
										...
										?>
                                    	<option value="<?php echo $row['teacher_id'];?>"><?php echo $row['ar_name'];?></option>
                                        <?php
										endforeach;
										?>
                                    </select>
