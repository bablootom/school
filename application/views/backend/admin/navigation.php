    ...
    <ul id="main-menu" class="">
        ...
        <li id="search">
  				<form class="" action="<?php echo site_url($account_type . '/student_details'); ?>" method="post">
  					<input type="text" class="search-input" name="student_identifier" placeholder="<?php echo get_phrase('student_name').' / '.get_phrase('code').'...'; ?>" value="" required style="font-family: 'Poppins', sans-serif !important; background-color: #6d5f18 !important; color: #868AA8; border-bottom: 1px solid #cab447;">
  					<button type="submit">
...
<!--                 <li class="<?php #if ($page_name == 'student_bulk_add') echo 'active'; ?> ">
                        ...
                        foreach ($classes as $row):
                            ...
                            <li class="<?php if ($page_name == 'student_information' && $class_id == $row['class_id'] || $page_name == 'student_marksheet' && $class_id == $row['class_id']) echo 'active'; ?>">
                                <a href="<?php echo site_url('admin/student_information/' . $row['class_id']); ?>">
                                    ...
                                    <span><?php echo get_phrase($row['name']); ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
            ...
            <ul>
             ...
             <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> ">
                <a href="<?php echo site_url('admin/teacher'); ?>">
                    <span><i class="entypo-dot"></i> <?php echo get_phrase('teacher_info'); ?></span>
                </a>
            </li> 
            </ul>           
        </li>
        ...
        <!-- EMPLOYEE -->
         <li class="<?php if ($page_name == 'employee_add' || $page_name == 'employee_info') echo 'active'; ?> ">
                <a href="#">
                ...
                <ul>
                    ...
                    <a href="<?php echo site_url('admin/employee_add'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('employee_add'); ?></span>
                    </a>
                </li>

                 <li class="<?php if ($page_name == 'employee_info') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/employee_info'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('employee_info'); ?></span>
                    </a>
                </li>
                </ul>
            </li>
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'section') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/section'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('manage_divisions'); ?></span>
                    </a>
                </li>
        ...
        <!-- statement of student -->
            <!-- <li class="<?php if ($page_name == 'statement_of_student') echo 'active'; ?> ">
                <a href="<?php echo site_url('admin/student_statement'); ?>">
                    <i class="entypo-book-open"></i>
                    <span><?php echo get_phrase('statement_of_student'); ?></span>
                </a>
            </li> -->
        ...
        if ($page_name == 'competition' ||
                $page_name == 'competition_entry')
                    echo 'opened active';
        ?> ">
            <a href="#">
                <i class="entypo-trophy"></i>
                <span><?php echo get_phrase('competition'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'competition') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/competition'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('create_competition_link'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'competition_entry') echo 'active'; ?> ">
                    <a href="<?php echo site_url('admin/competition_entry'); ?>">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('competition_entries'); ?></span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <!-- STUDY MATERIAL -->
        <li class="<?php if ($page_name == 'visa') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/visa'); ?>">
                <i class="entypo-doc-text-inv"></i>
                <span><?php echo get_phrase('visa'); ?></span>
            </a>
           
        </li>
        <!-- PRINT DATA -->
        <li class="<?php if ($page_name == 'print') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/print'); ?>">
                <i class="entypo-doc-text-inv"></i>
                <span><?php echo get_phrase('print'); ?></span>
            </a>
        </li>
        ...
        <!-- MESSAGE -->
         <li class="<?php if ($page_name == 'message' || $page_name == 'group_message') echo 'active'; ?> ">
            <a href="<?php echo site_url('admin/message'); ?>">
                ...
                <span><?php echo get_phrase('SMS_platform'); ?></span>
            </a>
        </li> 
