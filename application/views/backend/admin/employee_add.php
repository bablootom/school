<div class="row">
	<div class="col-md-10">
		<div class="panel panel-primary" data-collapsed="0">
        	<div>
            	<div>
            		<img width="100%" src="<?php echo base_url(); ?>assets/images/header_e.jpg">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(site_url('admin/employee/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                       <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('functional_number');?></label>
						<div class="col-sm-5">
                            <?php 
                                //$newid = $this->db->count_all_results('employee'); 
                                //$newid = $newid+1;
							    //$stud_id = 'BBRCE' . $newid; 
                            ?>
							<!-- <input type="text" class="form-control" name="Id_no" value="<?php echo strtoupper($stud_id) ?>" data-validate="required" id="student_code" data-message-required="<?php echo get_phrase('value_required');?>" readonly> -->
							<input type="text" class="form-control" name="Id_no" value="" data-validate="required" id="student_code" data-message-required="<?php echo get_phrase('value_required');?>">
						</div>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('social_status');?></label>
...
<select class="form-control" name="nationality" data-validate="required" data-message-required="<?php echo get_phrase('nationality_required');?>" required>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" id="dob" class="form-control datepicker" name="dob" value="" data-start-view="2">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="qualification" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus required>
					...
					<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('amount_of_conservation');?></label>
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="amount_of_conservation" value="">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="department_authorization" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" required>
                                ...
                                <option value="Not Certified">غير معتمد</option>
                                <option value="Laboratory">مختبر</option>
								<option value="Unchecked">غير مختبر</option> -->
								<option value="" selected disabled hidden><?php echo get_phrase('select');?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="job_title" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" required>
                                ...
                                <option value="Clean Worker">عامل نظافة</option>
								<option value="Curriculum Teacher">مدرس مناهج</option>
                                <option value="Driver">سائق</option>
                                <option value="Guard">حارس</option>
								<option value="Memorizer"> محفظ</option>
								<option value="Receptionist">موظف إستقبال</option>
								<option value="Secretary"> سكرتيرة</option>
								<option value="Technical Supervisor">مشرف فني</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="joining_year" value="" data-start-view="2">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="living" class="form-control" required>
								...
								<!-- <option value="Abu Dhabi">ابوظبی</option>
								<option value="Dubai">دبي</option>
								<option value="Sharjah">الشارقة</option>
                                <option value="Ajman">عجمان</option>
                                <option value="Ras Al Khaimah">رأس الخیمه</option>
								<option value="Fujairah">الفجيرة</option>								
								<option value="Umm Al Quwain">ام ال کویین</option> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="passport_no" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus required>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="pexpiry_date" value="" data-start-view="2">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="residency_no" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus required>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="rexpiry_date" value="" data-start-view="2" placeholder="yyyy-mm-dd">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="nearest_person_no" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus required>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">					
							<select name="guarantor" class="form-control" required>
                                ...
                                <option value="Family">ذويه</option> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="eid_no" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus required>
						</div>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('phone_1');?></label>

						<div class="col-sm-5">
							<input type="text" class="form-control" name="tel" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" placeholder="05xxxxxxxx" maxlength="10" value="" autofocus required>
						</div>

						
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('phone_2');?></label>

						<div class="col-sm-5">
							<input type="text" class="form-control" name="tel1" placeholder="05xxxxxxxx" maxlength="10" value="" autofocus >
						</div>
						
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('transportation');?></label>
						<?php 
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="address" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" value="" autofocus required>
						</div>
