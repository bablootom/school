		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(site_url('admin/teacher/do_update/'.$row['teacher_id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        ...
                        <div class="col-sm-5">
                            <?php $status = $this->db->get_where('teacher' , array(
                        ...
                        <select class="form-control" name="nationality" data-validate="required" data-message-required="<?php echo get_phrase('nationality');?>" required>
                                <option value="<?php echo $this->db->get_where('teacher' , array('teacher_id' => $row['teacher_id']))->row()->nationality; ?>"><?php echo $this->db->get_where('teacher' , array('teacher_id' => $row['teacher_id']))->row()->nationality; ?></option>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" name="job_title"
										value="<?php echo $row['job_title'] == null ? '' : $row['job_title'];?>" >
								</div>
							</div>
                            ...
                            <?php
                                ...
                                $transport_id =  $this->db->get_where('teacher' , array('teacher_id' => $row['teacher_id']))->row()->transport_id;
