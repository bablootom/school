<div class="row">
	<div class="col-md-12">
      ...
      <?php echo form_open(site_url('admin/teacher/create/') , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('passport_expiry');?></label>

						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="ppexpiry" value="" data-start-view="2">
						</div>
					</div>

					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('visa_number');?></label>

						<div class="col-sm-5">
							<input type="text" class="form-control" name="visa" value="" >
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="visaexpiry" value="" data-start-view="2">
						</div>
					</div>
