...
<div id="section_holder">
    <div class="col-md-3">
        ...
        <div class="form-group">
            <label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('division'); ?></label>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th><?php echo get_phrase('send_sms'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($attendance_of_students as $row):
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->ar_name; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="note_<?php echo $row['attendance_id']; ?>" value="<?php echo $row['note']; ?>" >
                            </td>
                            <td>
                                <select class="form-control" name="sms_<?php echo $row['attendance_id']; ?>">
                                    <option value="0" <?php if ($row['sms'] == 0) echo 'selected'; ?>><?php echo get_phrase('select'); ?></option>
                                    <option value="1" <?php if ($row['sms'] == 1) echo 'selected'; ?>><?php echo get_phrase('yes'); ?></option>
                                    <option value="2" <?php if ($row['sms'] == 2) echo 'selected'; ?>><?php echo get_phrase('no'); ?></option>
                                </select>
                            </td>
                        </tr>
                    <?php
